...
## 📄 רמות דפי עבודה – משוואות ריבועיות

המערכת חייבת לתמוך ברמות שונות של דפי עבודה בנושא משוואות ריבועיות, כאשר כל דף נבנה לפי רמת קושי מוגדרת מראש (ולא ערבוב).

### רמה 2 — משוואות עם x ו־x^2 (הוצאת גורם משותף)
- כל המשוואות ברמה זו הן מהצורה: יש איברי x^2 וגם איברי x (ולפעמים גם 0 בצד אחד).
- המטרה: להביא את המשוואה לצורה ax^2 + bx = 0 ואז להוציא גורם משותף x (או גורם משותף אחר אם יש).
- דוגמאות טיפוסיות (כיוונים שונים):
  - x^2 + 3x = 0
  - -4x^2 = x^2
  - -4x = -4x^2
- לפעמים 0 בצד ימין, לפעמים בצד שמאל, ולפעמים צריך קודם להעביר אגפים.
- אין נוסחת שורשים ברמה זו — הפתרון חייב להתבסס על הוצאת גורם משותף ופירוק בסיסי.

### רמה 3 — a=1 מלא, פירוק לגורמים עם שורשים שלמים בלבד
- המשוואות הן מהצורה: x^2 + bx + c = 0 עם a = 1.
- דרישה קריטית: הפתרונות חייבים להיות שלמים (ללא שברים).
- כלומר: b,c נבחרים כך שהמשוואה מתפרקת לגורמים עם מספרים שלמים:
  - דוגמה: x^2 - 8x + 15 = 0 (מתפרק, פתרונות שלמים)
- אין לייצר תרגילים שמובילים לשורשים לא שלמים/שברים ברמה זו.
